...
def plot_scatter_with_lines(x, y, brdf_color):
    ...
    if remove_max == True:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_scatter_theta' + str(theta_diagram) + '_phi' + str(
                phi_diagram) + '_rem.png', dpi=200)
    else:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_scatter_theta' + str(theta_diagram) + '_phi' + str(
                phi_diagram) + '.png', dpi=200)
...
def plot_interpolate_rbf(x, y, brdf_color):
    ...
    if remove_max == True:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_interp_theta' + str(theta_diagram) + '_phi' + str(
                phi_diagram) + '_rem.png', dpi=200)
    else:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_interp_theta' + str(theta_diagram) + '_phi' + str(
...
def polar_plot_scatter(th, ph, brdf_color):
    ...
    if remove_max == True:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_polar_theta' + str(theta_diagram) + '_phi' + str(
                phi_diagram) + '_rem.png', dpi=200)
    else:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_polar_theta' + str(theta_diagram) + '_phi' + str(
...
def polar_plot_scatter_more_details(th, ph, brdf_color):
    ...
    if remove_max == True:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_polar_theta' + str(theta_diagram) + '_phi' + str(
                phi_diagram) + '_more_details_rem.png', dpi=200)
    else:
        plt.savefig(
            path_save + txt_data + '_type' + str(plot_type) + '_polar_theta' + str(theta_diagram) + '_phi' + str(
                phi_diagram) + '_more_details.png', dpi=200)
